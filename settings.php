        ...
        <main class="row row-cols-1 row-cols-md-1 g-4" id="mainContent">
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <h2 class="card-title specialFont"><i class="far fa-user-cog"></i>Configurações do Perfil</h2>
                        <?php
                            if (!empty($_GET["msg"])){
                                if ($_GET["msg"] == 1){
                                    ...
                                    echo "<p class='card-text'>Veja e edite configurações de seu perfil aqui.<span class='fw-bold text-danger'> E-mail já inserido!</span></p>";
                                }
                            } else {
                        ...
                        <div id="clearfixContainerAccountSettings" class="clearfix">
                            <img id="profilePictureSettings" src="<?php echo $_SESSION['prof-picture']; ?>" class="rounded-circle float-start" alt="Foto do usuário">
                            <p class="card-text display-6" style="font-size:30px;"><?php echo $_SESSION["nome"]." ".$_SESSION["sobrenome"]; ?></p>
                            <p class="card-text"><i><?php echo $_SESSION["email"]; ?></p></i>
